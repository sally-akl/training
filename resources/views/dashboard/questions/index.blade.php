...
<div class="modal modal-blur fade" id="add_edit_modal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ url('dashboard') }}/questions" class="form_submit_model">
...
<script type="text/javascript">
  var _sucess = function(response)
  {
    if(response.sucess)
    {
      ...
      window.location.href = "{{ url('dashboard') }}/questions";
    }
    else
    {
      var $error_text = "";
  ...
  $(".edit_btn").on("click",function()
  {
      ...
      var url_edit = "{{url('dashboard') }}/questions"+"/"+id;
      $(".form_submit_model").attr("action",url_edit);
      $.ajax({
          url: "{{url('dashboard') }}/questions"+"/"+id+"/edit",
          type: 'GET',
          dataType: 'json',
  ...
  $(".add_btn").on("click",function(){
      ...
      $("input[name='method_type']").val("add");
      $(".form_submit_model").attr("action","{{ url('dashboard') }}/questions");
      $('#add_edit_modal').modal('show');
      return false;
  });
  ...
  $(".delete_it_sure").on("click",function(){
    ...
    var url_delete = "{{url('dashboard') }}/questions"+"/"+id;
