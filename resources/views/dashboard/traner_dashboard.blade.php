...
<div class="row row-deck row-cards">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex align-items-center">
          <div class="subheader">Your Clients</div>

        </div>
        <div class="d-flex align-items-baseline">
          <div class="h1 mb-0 mr-2">{{\App\User::selectraw("users.* , package.package_duration_type , package.package_duration , transactions.transfer_date , package.package_name , transactions.id as trans_id")->join("transactions","user_id","users.id")->join("package","package_id","package.id")->where("role_id",3)->where("package.user_id",Auth::id())->count()}}</div>
          <div class="mr-auto">
  ...
  <div class="col-sm-6 col-lg-3">
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <div class="subheader">Total Trainer Sales</div>
          <div class="ml-auto lh-1">
          </div>
        </div>
        <div class="d-flex align-items-baseline">
          <div class="h1 mb-0 mr-2">{{Auth::user()->transactions()->sum("amount")}} $</div>
          <div class="mr-auto">
  ...
  <div class="col-sm-6 col-lg-3">
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex align-items-baseline">
          <div class="h1 mb-3 mr-2">{{Auth::user()->transactions()->sum("amount") - Auth::user()->withdraws()->where("is_execute",1)->sum("withdrw_amount")}}$</div>
          <div class="mr-auto">
  ...
  <div class="col-sm-6 col-lg-3">
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex align-items-baseline">
          <div class="h1 mb-3 mr-2">{{ Auth::user()->withdraws()->where("is_execute",0)->sum("withdrw_amount")}}$</div>
          <div class="mr-auto">
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        @php  $traner_month_days = \App\Transactions::selectraw("transfer_date")->where("is_payable",1)->where("trainer_id",Auth::id())->whereraw("month(transfer_date) = ".date("n"))->get();
              $tr_month_days = [];
        ...
        @endphp
        @php $query_users_month_count =  \App\Transactions::selectraw("count(id) as user_count , transfer_date")->where("trainer_id",Auth::id())->where("is_payable",1)->whereraw("month(transfer_date) = ".date("n"))->groupby("created_at")->get();
  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      @php  $transactions = \App\Transactions::orderBy("id","desc")->where("trainer_id",Auth::id())->take(5)->get();  @endphp
  ...
  <div class="col-md-12 col-lg-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Sales & Earnings</h4>
      </div>
      <div class="table-responsive">
        @php  $sales_with_months = \App\Transactions::selectraw("YEAR(transfer_date) as year, MONTHNAME(transfer_date) as month,sum(amount) as total , count(id) as count")->where("trainer_id",Auth::id())->groupby("year",'month')->orderBy("id","desc")->get(); @endphp
        <table class="table card-table table-vcenter">
          <thead>
            <tr>
  ...
  <div class="col-md-6 col-lg-4">
    <div class="card">
      ...
      @php
        ...
        $users_payed =  \App\Transactions::selectraw("sum(amount) as traner_sum , name,email,image")->join("users","users.id","transactions.user_id")->where("is_payable",1)->where("trainer_id",Auth::id())->orderby("traner_sum","desc")->groupby("name","email","image")->get();
      @endphp
