...
<div class="modal modal-blur fade" id="add_edit_modal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ url('dashboard/slider') }}" class="form_submit_model">
...
<script type="text/javascript">
  ...
  var _sucess_msg = function(response)
  {
    ...
    window.location.href = '{{url("/dashboard/slider")}}';
  }
  ...
  $(".edit_btn").on("click",function()
  {
      ...
      var url_edit = '{{url("/dashboard/slider")}}'+"/"+id;
      $("input[name='item_id']").val(id);
      $(".form_submit_model").attr("action",url_edit);
      $.ajax({
          url: '{{url("/dashboard/slider")}}'+"/"+id+"/edit",
          type: 'GET',
          dataType: 'json',
  ...
  $(".add_btn").on("click",function(){
      ...
      $("input[name='method_type']").val("add");
        $(".img_profile").css("display","none");
      $(".form_submit_model").attr("action",'{{url("/dashboard/slider")}}');
      return false;
  });
  $(".form_submit_model").submit(function(e){
      ...
      if(formData.get("method_type") == "edit")
      {
          ...
          $.ajax({
              url: '{{url("/dashboard/sliders/uploadImage")}}'+"/"+id,
              type: 'post',
              data: formData,
              contentType: false,
              processData: false,
  ...
  $(".delete_it_sure").on("click",function(){
    ...
    var url_delete = '{{url("/dashboard/slider")}}'+"/"+id;
