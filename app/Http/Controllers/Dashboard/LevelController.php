...
class LevelController extends MainAdminController
{
    /**
    ...
    protected $check_permission = "manage_level";
    ...
    {
       $filters = Muscles::where("type","level")->orderBy("id","desc")->paginate($this->pagination_num);
       $type="level";
