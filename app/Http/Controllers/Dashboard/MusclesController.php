...
class MusclesController extends MainAdminController
{
    /**
    ...
    protected $check_permission = "manange_muscles";
    ...
    {
       $filters = Muscles::where("type","muscles")->orderBy("id","desc")->paginate($this->pagination_num);
       $type="muscles";
