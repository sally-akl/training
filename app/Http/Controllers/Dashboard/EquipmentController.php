...
class EquipmentController extends MainAdminController
{
    /**
    ...
    protected $check_permission = "manage_equipment";
    ...
    {
       $filters = Muscles::where("type","equipment")->orderBy("id","desc")->paginate($this->pagination_num);
       $type="equipment";
